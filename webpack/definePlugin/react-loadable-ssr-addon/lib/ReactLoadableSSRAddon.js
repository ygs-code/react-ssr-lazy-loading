...
var ReactLoadableSSRAddon = (function () {
    ...
    if (!WEBPACK_5) {
      for (var i = 0; i < modules.length; i += 1) {
        ...
        for (var j = 0; j < reasons.length; j += 1) {
          ...
          var userRequest = reason.dependency
  ...
  _proto.getMinimalStatsChunks = function getMinimalStatsChunks(
    compilationChunks,
  ) {
    var _this = this
  ...
  _proto.processAssets = function processAssets(originAssets) {
    ...
    this.assetsByName.forEach(function (value, key) {
      ...
      for (var _i = 0; _i < files.length; _i += 1) {
        ...
        var ext = (0, _utils.getFileExtension)(file)
          .replace(/^\.+/, '')
          .toLowerCase()
        ...
        if (!(0, _utils.hasEntry)(assets[id][ext], 'file', file)) {
          var shouldComputeIntegrity =
            Object.keys(currentAsset) &&
            _this2.options.integrity &&
            !currentAsset[_this2.options.integrityPropertyName]

          if (shouldComputeIntegrity) {
            currentAsset[_this2.options.integrityPropertyName] = (0,
            _utils.computeIntegrity)(
              _this2.options.integrityAlgorithms,
              currentAsset.source(),
            )
          }
          ...
          assets[id][ext].push({
            file: file,
            hash: hash,
            publicPath: _url['default'].resolve(
              _this2.options.publicPath || '',
              file,
            ),
